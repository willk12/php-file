...
include'./inc-midia/configuracoes.php'
?>

<div class="base">

    <div class="container d-flex flex-row m-auto">

        <img class="img-thumbnail" src="./assets/profile-picture.jpeg" alt="" width="200px" height="200px">
